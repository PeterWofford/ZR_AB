 ...
 */
    ...
    public static void main(String[] args) throws IOException {
        ...
        String textInsertPlaceHolder = "        /*see if constructor comment still here*/) {";		// replace with the main header
        String studentCode = "/home/peterwof/ZR_AB_fakeDB/API_define.txt";// path to student code
        String javaGameCodeFile = "/home/peterwof/ZR_AB_fakeDB/PlayerTemplate3.java"; //path to template
	    String pathToCombinedFile = "/home/peterwof/ZR_Astrobee/game_v_0.0/src/main/java/gov/nasa/arc/astrobee/ros/java_test_square_trajectory/PlayerTemplate.java"; //path to save the combined student and template code
